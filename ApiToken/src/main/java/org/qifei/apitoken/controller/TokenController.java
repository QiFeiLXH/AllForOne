package org.qifei.apitoken.controller;

import lombok.extern.slf4j.Slf4j;
import org.qifei.apitoken.annotation.NotRepeatSubmit;
import org.qifei.apitoken.entity.AccessToken;
import org.qifei.apitoken.entity.AppInfo;
import org.qifei.apitoken.entity.TokenInfo;
import org.qifei.apitoken.entity.UserInfo;
import org.qifei.apitoken.reponseResult.ApiResponse;
import org.qifei.apitoken.toolUtils.MD5Util;
...
public class TokenController {
    ...
    public ApiResponse<AccessToken> apiToken(String appId, @RequestHeader("timestamp") String timestamp, @RequestHeader("sign") String sign) {
        ...
        Long just = Long.valueOf(timestamp);
        long reqeustInterval = current - just;
